...
// KikAPI
#define COCOAPODS_POD_AVAILABLE_KikAPI
#define COCOAPODS_VERSION_MAJOR_KikAPI 0
#define COCOAPODS_VERSION_MINOR_KikAPI 1
#define COCOAPODS_VERSION_PATCH_KikAPI 0
